...
export const Login: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-slate-950 flex items-center justify-center p-6 text-slate-50 relative overflow-hidden">
            {/* Background Blob */}
            <div className="absolute top-0 -left-20 w-96 h-96 bg-amber-500/10 rounded-full blur-3xl filter opacity-50 pointer-events-none"></div>
            ...
            >
                <div className="text-center mb-8">
                    ...
                    <p className="text-slate-400 mt-2">Sign in to continue to VoiceChef</p>
                </div>
                ...
                <p className="mt-8 text-center text-slate-400">
                    ...
                    <Link to="/signup" className="text-amber-500 hover:text-amber-400 font-medium transition-colors hover:underline">
                        Sign up
                    </Link>
                </p>
